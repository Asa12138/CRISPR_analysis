...
### 6. Intraspecies_targeting

-   Investigate the association and patterns between within-species CRISPR-Cas targeting and HGT.

### 7.Simulation

-   Use simulated populations to examine how CRISPR-Cas–mediated inhibition of HGT influences species divergence.
-   Record functions simulating different evolutionary factors and basic visualization code
...
For questions or collaborations, please contact: [[lz19\@zju.edu.cn](mailto:lz19@zju.edu.cn){.email}]
