...
### ternary plot
```{r}
pdf(file = "2.4.Tri_target/1.arc_tri_target.pdf",width = 13,height = 8)
...
pdf("2.4.Tri_target/1.arc_top10genome_tri_target.pdf")
for (i in top10) {
...
filter(self_df_and_count,Level=="Species")%>%arrange(-genome_count)%>%write.csv("2.4.Tri_target/arc_self_df_and_count.csv",row.names = F)
...
pdf("2.4.Tri_target/1.arc_top10_self_genome_tri_target.pdf")
...
### tree plot
```{r}
pdf("2.4.Tri_target/2.arc_tri_target_tree.pdf",width = 13,height = 10)
for (i in 3:7) {
...
```{bash}
scp -P 45777 pengchen@10.73.29.10:/share/home/jianglab/shared/ouxinyi2liuzhen/bacteria24/bac23_split/pc/bac_net_19.RDS ~/Documents/R/CRISPR_analysis/analysis/2.Blast_res/
```
...
if(!"target_Kingdom"%in%colnames(bac_count))bac_count=left_join(bac_count,bac_target_tax,
                                                                by=c("target_name"="target_Species"),suffix = c("", ".y"),keep=T)
if(!"source_Kingdom"%in%colnames(bac_count))bac_count=left_join(bac_count,bac_source_tax,
                                                                by=c("source_name"="source_Species"),suffix = c("", ".y"),keep=T)


dir.create("2.4.Tri_target/bac_sankey/")
#指定two_level时展示指定level,topN1指定各个bar的元素
sankey_overview(bac_count,two_level = c("Phylum","Kingdom"),topN1 = c(5,3))

#直接导出各个level的结果
sankey_overview(bac_count,file = "2.4.Tri_target/bac_sankey/bac")
```
...
"scp -P 45777 -r pengchen@10.73.29.10:/share/home/jianglab/shared/ouxinyi2liuzhen/bacteria24/bac23_split/1.bac_self_df1.RDS ~/Documents/R/CRISPR_analysis/analysis/2.4.Tri_target/"
"scp -P 45777 -r pengchen@10.73.29.10:/share/home/jianglab/shared/ouxinyi2liuzhen/bacteria24/bac23_split/1.bac_genome_c.RDS ~/Documents/R/CRISPR_analysis/analysis/2.4.Tri_target/"
...
"scp -P 45777 -r pengchen@10.73.29.10:/share/home/jianglab/shared/ouxinyi2liuzhen/bacteria24/bac23_split/1.bac_self_df2.RDS ~/Documents/R/CRISPR_analysis/analysis/2.4.Tri_target/"
"scp -P 45777 -r pengchen@10.73.29.10:/share/home/jianglab/shared/ouxinyi2liuzhen/bacteria24/bac23_split/1.bac_self_df3.RDS ~/Documents/R/CRISPR_analysis/analysis/2.4.Tri_target/"
```
...
### ternary plot
```{r}
self_df=readRDS("2.4.Tri_target/1.bac_self_df1.RDS")
  
pdf(file = "2.4.Tri_target/1.bac_tri_target.pdf",width = 13,height = 8)
plot.self_df(self_df,mode = 1,filter_spacer = 20)
plot.self_df(self_df,mode = 2,filter_spacer = 20)
#dev.off()

#真正的genome-genome self-target
if(file.exists("2.4.Tri_target/1.bac_self_df2.RDS")){
  self_df2=readRDS("2.4.Tri_target/1.bac_self_df2.RDS")
  plot.self_df(self_df2,filter_spacer = 20)
}
if(file.exists("2.4.Tri_target/1.bac_self_df3.RDS")){
  self_df3=readRDS("2.4.Tri_target/1.bac_self_df3.RDS")
  plot.self_df(self_df3,filter_spacer = 20)
}
...
#挑genome比较多的source species
genome_c=readRDS("2.4.Tri_target/1.bac_genome_c.RDS")
genome_c%>%arrange(-genome_count)%>%head(10)%>%pull(source_name)->top10


# pdf("2.4.Tri_target/1.bac_top10genome_tri_target.pdf")
# for (i in top10) {
...
filter(self_df_and_count,Level=="Species")%>%arrange(-genome_count)%>%write.csv("2.4.Tri_target/bac_self_df_and_count.csv",row.names = F)
...
#绘制self-target最多的一些物种内的genome情况
pdf("2.4.Tri_target/1.bac_top10_self_genome_tri_target.pdf")
