...
library(readr)
library(dplyr)
mycob_after_lca=read_delim("2.1.Self_target/mycob_after_lca",delim = "\t")
# 195,979个spacer
...
mycob_net=read_delim("2.1.Self_target/mycob_net")
...
```{bash}
scp -P 45777 -r pengchen@10.73.29.10:/share/home/jianglab/shared/ouxinyi2liuzhen/bacteria23/mycob_source_genome_stat ~/Documents/R/CRISPR_analysis/analysis/2.1.Self_target/
scp -P 45777 -r pengchen@10.73.29.10:/share/home/jianglab/shared/ouxinyi2liuzhen/bacteria23/mycob_target_genome_stat ~/Documents/R/CRISPR_analysis/analysis/2.1.Self_target/

scp -P 45777 -r pengchen@10.73.29.10:/share/home/jianglab/shared/ouxinyi2liuzhen/bacteria23/mycob_after_lca ~/Documents/R/CRISPR_analysis/analysis/2.1.Self_target/
scp -P 45777 -r pengchen@10.73.29.10:/share/home/jianglab/shared/ouxinyi2liuzhen/bacteria23/mycob_net ~/Documents/R/CRISPR_analysis/analysis/2.1.Self_target/
```
...
mycob_after_lca_stat=read_delim("2.1.Self_target/mycob_source_genome_stat")
mycob_after_lca_target=read_delim("2.1.Self_target/mycob_target_genome_stat")
...
```{bash}
scp -P 45777 -r pengchen@10.73.29.10:/data/home/jianglab/share/bac2pc/mycob_all_crispr.rda ~/Documents/R/CRISPR_analysis/analysis/2.1.Self_target/
scp -P 45777 -r pengchen@10.73.29.10:/data/home/jianglab/share/bac2pc/Corynebacterium_diphtheriae_all_crispr.rda ~/Documents/R/CRISPR_analysis/analysis/2.1.Self_target/
```

```{r}
load("2.1.Self_target/Corynebacterium_diphtheriae_all_crispr.rda")
...
```{bash}
scp -P 45777 -r pengchen@10.73.29.10:/share/home/jianglab/shared/ouxinyi2liuzhen/bacteria23/Corynebacterium_diphtheriae_target_genome_stat ~/Documents/R/CRISPR_analysis/analysis/2.1.Self_target/
scp -P 45777 -r pengchen@10.73.29.10:/share/home/jianglab/shared/ouxinyi2liuzhen/bacteria23/Corynebacterium_diphtheriae_source_genome_stat ~/Documents/R/CRISPR_analysis/analysis/2.1.Self_target/

scp -P 45777 -r pengchen@10.73.29.10:/share/home/jianglab/shared/ouxinyi2liuzhen/bacteria23/Corynebacterium_diphtheriae_after_lca ~/Documents/R/CRISPR_analysis/analysis/2.1.Self_target/

scp -P 45777 -r pengchen@10.73.29.10:/share/home/jianglab/shared/ouxinyi2liuzhen/bacteria23/genome_stat/sp_genome_stat.tar.gz ~/Documents/R/CRISPR_analysis/analysis/2.1.Self_target/
```

```{r}

sp="Corynebacterium_diphtheriae"
mycob_after_lca=read_delim(paste0("2.1.Self_target/",sp,"_after_lca"),delim = "\t")
mycob_net=count(mycob_after_lca,source_genome,target_genome)
write_delim(mycob_net,file = "codi_net")

mycob_net=read_delim("2.1.Self_target/codi_net")
devtools::load_all("~/Documents/R/MetaNet/")
mycob_net=c_net_from_edgelist(mycob_net,direct = T)
